...
> = {
  crackers: { emojis: ["🎆", "🎇", "✨", "💥"], mode: "burst", count: 14 },
  birthday: { emojis: ["🎂", "🎈", "🎉", "🥳"], mode: "burst", count: 12 },
  diwali: { emojis: ["🪔", "✨", "🎇"], mode: "rise", count: 12 },
  holi: { emojis: ["🎨", "🌈", "💜", "💛"], mode: "burst", count: 14 },
  christmas: { emojis: ["❄️", "🎄", "⛄"], mode: "fall", count: 16 },
  newyear: { emojis: ["🎉", "🎊", "🥂"], mode: "fall", count: 16 },
  hearts: { emojis: ["💖", "💗", "💘"], mode: "rise", count: 12 },
